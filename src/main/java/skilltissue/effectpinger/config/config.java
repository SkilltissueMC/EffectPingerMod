...
public class config extends MidnightConfig {
    ...
    @Entry(category = EFFECT, name = "Sound pitch", isSlider = true, min = 0F, max = 3, precision = 2) public static float pitch = 1;
    @Entry(category = EFFECT, name = "Sound Volume - ", isSlider = true, min = 1F, max = 30) public static float volume = 15;
